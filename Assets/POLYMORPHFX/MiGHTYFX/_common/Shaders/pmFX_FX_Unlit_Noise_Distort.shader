...
Shader "pmFX/FX/FX_Unlit_Noise_Distort"
{
	Properties
	{
		...
		[ASEEnd]_DepthDistance("Depth Distance", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 appendResult43 = (float2(IN.ase_texcoord3.z , IN.ase_texcoord3.w));
				float2 texCoord6 = IN.ase_texcoord3.xy * float2( 1,1 ) + appendResult43;
				float2 panner7 = ( ( _NoiseSpeed * ( 1.0 - _TimeParameters.x ) ) * float2( 1,1 ) + ( _NoiseScale * texCoord6 ));
				float4 tex2DNode18 = tex2D( _MainTex, ( texCoord14 + ( texCoord14.y * ( tex2D( _NoiseTex, panner7 ).r - 0.0 ) * texCoord14.y ) ) );
				float4 clampResult64 = clamp( ( tex2DNode26.r * _ParticleColor * tex2DNode18 * IN.ase_color ) , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) );
				float4 screenPos = IN.ase_texcoord4;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth66 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth66 = saturate( abs( ( screenDepth66 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthDistance ) ) );
				float temp_output_68_0 = ( ( _Opacity * IN.ase_color.a * tex2DNode18.a * tex2DNode26.a ) * distanceDepth66 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( _Emissive * ( _Emissive * clampResult64 * temp_output_68_0 ) ) * temp_output_68_0 ).rgb;
				float Alpha = temp_output_68_0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult43 = (float2(IN.ase_texcoord2.z , IN.ase_texcoord2.w));
				float2 texCoord6 = IN.ase_texcoord2.xy * float2( 1,1 ) + appendResult43;
				float2 panner7 = ( ( _NoiseSpeed * ( 1.0 - _TimeParameters.x ) ) * float2( 1,1 ) + ( _NoiseScale * texCoord6 ));
				float4 tex2DNode18 = tex2D( _MainTex, ( texCoord14 + ( texCoord14.y * ( tex2D( _NoiseTex, panner7 ).r - 0.0 ) * texCoord14.y ) ) );
...
/*ASEBEGIN
Version=18912
441;604;717;405;-1593.606;608.369;2.773147;True;False
...
Node;AmplifyShaderEditor.ClampOpNode;64;2344.065,-176.4006;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,1;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;56;2583.604,-162.6947;Inherit;False;3;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;74;2802.941,-131.8775;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=CCA96F89A2885C19241898C82CDDE8DEAE9ADC5B