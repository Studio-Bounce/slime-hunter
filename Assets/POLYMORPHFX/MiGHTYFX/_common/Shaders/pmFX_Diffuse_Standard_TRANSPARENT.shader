	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 unpack11 = UnpackNormalScale( tex2D( _NormalTex, uv_NormalTex ), _NormalScale );
				...
				float3 Albedo = ( _TintColor * tex2DNode2 ).rgb;
				float3 Normal = unpack11;
				float3 Emission = saturate( ( _EmissiveColor * tex2D( _EmissiveTex, uv_EmissiveTex ) * _Intensity ) ).rgb;
				float3 Specular = 0.5;
				float Metallic = color22.r;
				float Smoothness = color22.r;
				float Occlusion = 1;
				float Alpha = ( _TintColor.a * tex2DNode2.a );
...
/*ASEBEGIN
Version=18912
486;604;756;405;564.4207;80.26447;1.390568;True;False
...
Node;AmplifyShaderEditor.ColorNode;22;-1.906755,104.1825;Inherit;False;Constant;_MetallicSmoothness1;Metallic/Smoothness;7;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=ED871022F4BD6958AA16266CF1607F4D87F361DC