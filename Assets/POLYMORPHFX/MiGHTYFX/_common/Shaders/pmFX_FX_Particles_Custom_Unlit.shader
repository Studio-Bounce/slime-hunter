...
Shader "pmFX/FX/FX_Particles_Custom_Unlit"
{
	Properties
	{
		...
		[ASEBegin][HDR]_ParticleColor("Particle Color", Color) = (1,1,1,1)
		...
		[ASEEnd]_PowerScale("Power Scale", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float distanceDepth17 = saturate( abs( ( screenDepth17 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthDistance ) ) );
				float temp_output_19_0 = saturate( ( ( tex2DNode1.a * IN.ase_color.a * _ParticleColor.a ) * distanceDepth17 ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( _Emissive * saturate( pow( ( ( _ParticleColor * tex2DNode1 ) * IN.ase_color ) , temp_cast_0 ) ) ) * temp_output_19_0 ).rgb;
...
/*ASEBEGIN
Version=18912
441;604;717;405;1330.702;201.2648;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-569.915,497.1248;Inherit;False;Property;_DepthDistance;Depth Distance;7;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;552.9347,121.1955;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;8;418.0011,-61.41316;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;7;-194.862,-253.6619;Inherit;False;Property;_Emissive;Emissive;3;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-917.1145,61.42542;Inherit;False;Property;_CullMode;CullMode;6;1;[Enum];Create;True;0;1;Option1;0;1;UnityEngine.Rendering.CullMode;True;0;False;2;1;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=EC9F510CBF4DF9AFF77ED72B7A2022BBFCDE0468